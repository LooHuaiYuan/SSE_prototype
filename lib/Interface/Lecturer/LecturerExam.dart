...
class LecturerExam extends StatefulWidget{
  @override
  _LecturerExam createState()=> _LecturerExam();
}

class _LecturerExam extends State<LecturerExam> {
                    ...
                    children: <Widget>[const Padding(
                      ...
                      Transform.translate(
                        ...
                        child: ElevatedButton(
                            ...
                            child: const Text('SECURITY TYPE')
                        ),
                      ),
                    ],
                  ),
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: TextButton(
                    onPressed: () {
                      Navigator.pushNamed(context, '/LecturerAssessment');
                    },
                    child: Text(
                      'MARK',
                      style: TextStyle(
