...
class LecturerQuestionBank extends StatefulWidget {
  const LecturerQuestionBank({super.key});

  @override
  State<LecturerQuestionBank> createState() => _LecturerQuestionBankState();
}

class _LecturerQuestionBankState extends State<LecturerQuestionBank> {
  @override
                ...
                Padding(
                  ...
                  child: InkWell(
                    child: TextButton(
                      ...
                      onPressed: () {
                        Navigator.popAndPushNamed(context, '/LecturerPerformance');
                      },
                    ),
                  ),
                ),
                      ...
                      Column(
                        children: [
                          Padding(
                            ...
                            child: IconButton(
                                onPressed: () {
                                  Navigator.pushNamed(context, '/LecturerExam');
                                } ,
                      ...
                      Column(
                        children: [
                          Padding(
                            ...
                            child: IconButton(
                              onPressed: () {
                                Navigator.pushNamed(context, '/LecturerExercise');
                              } ,
                              icon: const ImageIcon(
